...
public class ControladorUsuario implements IControladorUsuario {
    ...
    public void seguirUsuario(String usuario, String usuarioASeguir){
            this.servicioUsuarios.addSeguidor(usuario, usuarioASeguir);
    }
    public void dejarDeSeguirUsuario(String usuario, String usuarioADejar){
            this.servicioUsuarios.dejardeSeguir(usuario, usuarioADejar);
    }
...
//        String[] partes2 = partes[1].split("\\)");
    ...
    public List<Usuario> obtenerEspectadoresRegistrados(String nombreFuncion){
        List<Usuario> respuesta = this.servicioUsuarios.obtenerEspectadoresRegistrados(nombreFuncion);
        return respuesta;
    }
}
